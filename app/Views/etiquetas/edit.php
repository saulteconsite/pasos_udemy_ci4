...
<form action="<?= base_url('/etiquetas/update/' . $etiqueta['id']) ?>" method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="nombre" name="nombre" value="<?= old('nombre', esc($etiqueta['nombre'])) ?>" required>
    </div>
